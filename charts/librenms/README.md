...
![Version: 11.0.1](https://img.shields.io/badge/Version-11.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 26.8.2](https://img.shields.io/badge/AppVersion-26.8.2-informational?style=flat-square)
...
The following table lists the main configurable parameters of the librenms chart v11.0.1 and their default values. Please, refer to [values.yaml](./values.yaml) for the full list of configurable parameters.
